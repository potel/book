...
\section{Examples and Applications}
  ...
  In Fig. \ref{fig6.2.1} (a), the absolute differential cross section associated with the population of the low--lying state $|^{119}\text{Sn}(7/2^+;788 \text{keV})\rangle$ in the one--particle pick--up process $^{120}$Sn$(p,d)^{119}$Sn and  worked out with the help of the software \textsc{one}\footnote{\cite{Potel:12b}; see also App. \ref{C8AppD}.}, of global optical parameters\footnote{\cite{Dickey:82}.} and of NFT spectroscopic amplitudes (Table \ref{tab4.2.1}), is compared with the experimental data.     
...
\hline
    \end{tabular}\caption{Experimental ($E_x$) and theoretical $(E'_x)$ quasiparticle excitation energies and theoretical effective occupation amplitude  associated with valence orbital $g_{7/2}$ (\cite{Idini:15}).}\label{tab4.2.1}
    \end{table}
  ...
  \begin{figure}
  	...
  	\caption{$(NFT)_{ren}$ diagrams describing the renormalization  processes
  		...
  		associated with the eventual decay of the quadrupole vibration of $^{10}$Be (Fig \ref{fig6.6.2} (II)).}\label{fig6.2.3x}
  \end{figure} 
  \begin{figure}
...
\end{figure}
  \begin{figure}
	...
	\caption{Predicted angular distributions obtained by integrating the absolute double differential cross section $d\sigma/dEd\Omega$ in the energy interval 0--0.2 MeV.}\label{fig5.2.6}
\end{figure}

As seen from Fig. \ref{fig5.2.5} the situation changes radically if one puts the same question but changing the angular range from $5.5^\circ\leq\theta_{cm}\leq16.5^\circ$ into $50^\circ\leq\theta_{cm}\leq180^\circ$. Equally univocally the answer now reads \textit{large}.
