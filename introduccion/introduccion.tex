...
Within this context we refer to Fig. \ref{fig1.4.2}, and to the fact that the nuclear ground state (nuclear vacuum) virtually contains all the physics of the system, as demonstrated by acting with the variety of external field which exhaustively probes it.
...
1 MeV ($d_{5/2}$ centroid),  809 keV (=1730--921) keV  ($d_{5/2}$ width), 10 $B_{sp}$ (B(E2)), 2250 mb ($\sigma_{2n}(p,t)$)) is given (for details see \cite{Idini:15}, also Fig. \ref{fig1.4.1}).}
\label{tab1.4.1}
\end{center}
\end{table}
...
\end{align}
  Regarding the NFT of the above questions we refer to Sect. \ref{appintroA} as well as to App. \ref{App1.C} (Sect. \ref{AppCS2}). In what follows we provide a simple, necessarily qualitative, estimate of the NFT prediction can be made making use of the relations\footnote{see Tables 4.5 and 4.6  \cite{Bortignon:77}.}.
\begin{align}
