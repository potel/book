...
\end{equation}
where $D_0$ is an empirical parameter ($D_0^2=(31.6\pm9.3)\times10^4$ MeV$^2$fm$^2$) determined to reproduce the observed absolute cross sections\footnote{\cite{Broglia:73}.}.
